        ...
        <div class="row mt-5 pt-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <small class="text-muted">Category: <span class="text-dark"><a href="pro.php?category=<?php echo htmlentities($Category); ?>"><?php echo htmlentities($Category); ?></a></span> & Written by <span class="text-dark"><?php echo htmlentities($Admin); ?></span> On <span class="text-dark"><?php echo htmlentities($DateTime) ?></span></small>
