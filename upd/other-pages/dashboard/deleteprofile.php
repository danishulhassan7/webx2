...
<head>
    <meta charset="utf-8" />
    <title>MazdoorHaazir | Delete Profile</title>
...
<body>
    ...
    <!-- Dashboard Starts  -->
    <!-- header  -->
    <header class="bg-purple clr-yellow py-2">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card bg-dark text-light mb-3">
                        <div class="card-body custom-style">
                            <div class="form-group">
                                ...
                                <input disabled type="text" class="form-control" id="title" name="PostTitle" placeholder="Type title here" value="selected">
                            </div>
                            <div class="form-group">
                            ...
                            <img class="mb-1" src="" width="80px" height="45px" alt="">
                            </div>
                            <div class="form-group">
