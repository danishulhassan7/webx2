...
<head>
    <meta charset="utf-8" />
    <title>MazdoorHaazir | Contact Us</title>
...
<body>
        ...
        <div class="container">
            ...
            <div id="navigation">
                ...
                <ul class="navigation-menu">
                    ...
                    <li><a href="contact.php" class="clr-yellow">Contact</a></li>
    ...
    <!-- hereo section starts  -->
    <div class="container mb-5 mt-5 pt-5">
        <div class="row align-items-center mb-5 mt-5 pt-3">
            <div class="col-lg-5 col-md-6">
                <img src="img/mh.png" class="img-fluid rounded-md shadow-lg" alt="">
            </div>
            <!--end col-->

            <div class="col-lg-7 col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
                <div class="section-title text-md-left text-center ml-lg-4">
                    <h4 class="title mb-4">Join the MHP team anytime <br>  from anywhere.</h4>
                    <p class="text-muted mb-0 para-desc">Start finding labours with <span
                        class="text-primary font-weight-bold">MazdoorHaazir</span>, we provide you the experienced labour teams at your doorstep..</p>
                    ...
                    <div class="media align-items-center text-left mt-4 pt-2">
                        ...
                        <div class="media-body">
                            <a href="#" class="text-dark h6">Find Better Leads</a>
                        </div>
                    </div>
                    ...
                    <div class="media align-items-center text-left mt-4">
                        ...
                        <div class="media-body">
                            <a href="#" class="text-dark h6">Get work opportunites</a>
                        </div>
                    </div>
                    ...
                    <div class="media align-items-center text-left mt-4">
                        ...
                        <div class="media-body">
                            <a href="#" class="text-dark h6">Get Paid Seemlessly</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        ...
                        <p class="text-muted para-desc mx-auto mb-0" data-aos="fade-up" data-aos-duration="1400">Start finding labours with <span
                            class="text-primary font-weight-bold">MazdoorHaazir</span>, we provide you the experienced labour teams at your doorstep.</p>
                    </div>
                </div>
                <!--end col-->
            ...
            <div class="row align-items-center">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <input name="email" id="email2" type="email"
                                                        class="form-control pl-5" placeholder="Your email :">
                                                </div>
                                            </div>
                                        </div>
                                        <!--end col-->
                ...
                <div class="col-lg-7 col-md-6 mt-4 pt-2 order-1 order-md-2">
                    <div class="title-heading ml-lg-4">
                        ...
                        <p class="text-muted" data-aos="fade-up" data-aos-duration="1400">Start finding labours with <span
                            class="text-primary font-weight-bold">MazdoorHaazir</span>, we provide you the experienced labour teams at your doorstep.</p>
                            ...
                            <div class="card-body p-0">
                                <div class="contact-detail d-flex align-items-center mt-3" data-aos="fade-up"
                                    ...
                                    <div class="content overflow-hidden d-block">
                                        ...
                                        <a href="mailto:contact@mazdoorhaazir.com"
                                            class="text-primary">contact@mazdoorhaazir.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-0">
                                <div class="contact-detail d-flex align-items-center mt-3" data-aos="fade-up"
                                    ...
                                    <div class="content overflow-hidden d-block">
                                        ...
                                        <a href="tel:+92 308-2157220" class="text-primary">+92 308-2157220</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-0">
                                <div class="contact-detail d-flex align-items-center mt-3" data-aos="fade-up"
                                    ...
                                    <div class="content overflow-hidden d-block">
                                        ...
                                        <a href="https://goo.gl/maps/C7iwg8M4NHt1L1rY8" target="_blank"
        ...
        <div class="container mt-100 mt-60">
            <div class="row">
                <div class="col-12 p-0">
                    <div class="map">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3620.380753628325!2d67.00172751447731!3d24.85084215176435!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33e03e02fabc1%3A0x96c129db3ee25a57!2sSindh%20Madressa-tul-Islam%20University%2C%20City%20Campus%2C%20Karachi!5e0!3m2!1sen!2s!4v1651079097098!5m2!1sen!2s"
