...
<body>
    ...
    <section>
        ...
        <div class="main-container" style="background-color: #5c0931 !important; color:#ffa903 !important;">
            <div class="forms-container" style="background-color: #5c0931 !important; color:#ffa903 !important;">
                <div class="signin-signup" style="background-color: #5c0931 !important; color:#ffa903 !important;">
                    <!-- Form 1 Sign In (Login) -->
                    <form class="sign-in-form" action="userlogin.php" method="POST">
                        <h2 class="titl">Sign In</h2>
                        ...
                        <input type="submit" value="Login" class="button solid" name="submit" style="background-color: #ffa903 !important; color: #5c0931  !important;">
                    ...
                    <form action="userlogin.php" method="POST" class="sign-up-form">
                        ...
                        <input style="background-color: #ffa903 !important; color: #5c0931  !important;" type="submit" value="Sign up" class="button solid" name="Submit">
        ...
        <div class="row">
            ...
            <div class="panels-container" >
                ...
                <div class="panel left-panel">
                    <div class="content">
                        <h3 style="color: #ffa903  !important;">New here ? </h3>
                        <p>Are you looking to hire laborers, sign in to view the top laborer profiles.</p>
                        <button style="background-color: #ffa903 !important; color: #5c0931  !important;" type="button" class="button transparent" id="sign-up-btn"><strong>Sign up</strong></button>
                    </div>
                ...
                <div class="panel right-panel">
                    <div class="content">
                        <h3>One of us ? </h3>
                        <p>MazdoorHaazir Platform, to connect with top profiles of laborers.</p>
                        <button style="background-color: #ffa903 !important; color:#5c0913 !important;" type="button" class="button transparent" id="sign-in-btn"><strong>Sign in</strong></button>
                    </div>
